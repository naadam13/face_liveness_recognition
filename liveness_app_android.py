...
# define function
# def livenessapp(model_path, le_path, detector_folder, confidence=0.5):
...
while True:
    ...
    img_resp = requests.get(args['url']+"/"+"shot.jpg")
...
#     livenessapp('liveness.h5', 'label_encoder.pickle', 'face_detector', confidence=0.5)